...
class PaymentController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        }elseif ($data->payment_type == "bank_transfer" && $data->bank == "bca") { 
        ...
        }elseif ($data->payment_type == "bank_transfer" && $data->bank == "bni") { 
            // $order_join = Order::where('code', $data->order_code)->with(array('product'=>function($query){
            //     $query->select();
            // }))->get();
            // $array_item = [];
        ...
        }elseif ($data->payment_type == "bank_transfer" && $data->bank == "bri") { 
            // $order_join = Order::where('code', $data->order_code)->with(array('product'=>function($query){
            //     $query->select();
            // }))->get();
            // $array_item = [];
        ...
        }elseif ($data->payment_type == "bank_transfer" && $data->bank == "permata") { 
            // $order_join = Order::where('code', $data->order_code)->with(array('product'=>function($query){
            //     $query->select();
            // }))->get();
            // $array_item = [];
